...
import { Users, ShoppingBag, TrendingUp, Settings, Package, Bell, Wallet, ChevronRight, LogOut, MapPin } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const menuItems = [
    ...
    ...(!isRegionalManager ? [
      { label: "区域代理", desc: "配置代理商和出货地点", path: "/admin/regional-managers", icon: MapPin, color: "bg-orange-100 text-orange-600" },
